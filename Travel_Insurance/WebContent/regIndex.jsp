...
<form action="RegistrationAdd" method="post" style="border:1px solid #ccc" name="val" onsubmit="return validate()" >
  <div class="container">
    ...
    <input type="text" placeholder="Start Date(yyyy/mm/dd)" name="startdate" required>
    
    <label for="enddate"><b>End Date</b></label>
    <input type="text" placeholder="End Date(yyyy/mm/dd)" name="enddate" required>
    
    <label for="nominee"><b>Mobile</b></label>
    <input type="text" placeholder="Mobile" name="mobile" required>
    
    <label for="policyname"><b>Policy Name:</b></label>
    <input type="text" placeholder="Policy Name" name="policyname" value="<%=request.getParameter("domestic")%>" required>
    
    <label for="nominee"><b>Nominee</b></label>
    <input type="text" placeholder="Nominee" name="nominee" required> 
      
    <label for="amount"><b>Amount</b></label>
    <!-- <input type="text" placeholder="Amount" name="amount" required> -->
    
    <input type="text" placeholder="Amount" name="amount" value="<%=request.getParameter("platinum")%>" required readonly>
